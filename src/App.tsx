    ...
    <div>
      <section className="border-b bg-[#f7f3eb]">
        <div className="container grid gap-8 py-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:py-18">
          <div><Eyebrow>Study path</Eyebrow><h1 className="section-title text-4xl lg:text-5xl">Follow the GH-600 blueprint.</h1><p className="mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">Use the official learning modules and study guide to build knowledge across all six exam domains, then reinforce it with focused practice.</p></div>
      ...
      <section className="container py-14 text-center lg:py-16"><h2 className="font-display text-3xl font-extrabold tracking-tight">Ready to test the first pass?</h2><p className="mx-auto mt-3 max-w-xl text-muted-foreground">Use a full exam to establish your baseline, then alternate focused drills with review.</p><Button size="lg" className="mt-6" onClick={onPractice}>Choose a practice mode <ArrowRight className="h-4 w-4" /></Button></section>
    </div>
  )
}
