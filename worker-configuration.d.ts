/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.dev.vars.example --strict-vars=false` (hash: d43ebf0fb62d7f94894801a29182302f)
...
interface __BaseEnv_Env {
	...
	COREEX_API_ORIGIN: string;
	COREEX: DurableObjectNamespace<import("./worker/index").CoreExContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "CoreExContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "AUTH_TOKEN_ISSUER" | "AUTH_TOKEN_AUDIENCE" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "POSTGRES_CONNECTION_STRING" | "COREEX_API_ORIGIN">> {}
}
